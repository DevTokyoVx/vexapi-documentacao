...
Este repositório foi criado para ajudar **usuários da Vex API** a encontrarem exemplos funcionais, rápidos e práticos de como utilizar os recursos disponíveis.

Aqui você vai encontrar:

- Exemplos prontos de uso em Node.js  
- Rotas explicadas de forma simples  
