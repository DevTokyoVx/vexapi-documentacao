 ...
 *
 * 🧠 DESCRIÇÃO:
 *   Aplica um efeito de desfoque (Gaussian Blur) em uma imagem fornecida.
 *
 * ⚙️ PARÂMETROS:
 *   - query: string (obrigatório)
 *     URL da imagem que deseja desfocar.
 *
 * 🔑 AUTENTICAÇÃO:
 ...
 *   - O efeito é aplicado de forma uniforme em toda a imagem.
 *
 * 👨‍💻 CRIADO POR:
 *   Vex Tech Solutions
 *
