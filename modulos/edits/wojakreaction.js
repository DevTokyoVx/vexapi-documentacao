/**
 * ============================================
 * 📡 VEX API - EDITS / WOJAK REACTION
 * ============================================
 *
 * 🔗 ENDPOINT:
 *   /api/edits/wojakreaction
 *
 * 🧠 DESCRIÇÃO:
 *   Sobrepõe a imagem fornecida em um template clássico de meme Wojak (Soyjak pointing).
 *
 * ⚙️ PARÂMETROS:
 *   - query: string (obrigatório)
 *     URL da imagem que o Wojak vai reagir.
 *
 * 🔑 AUTENTICAÇÃO:
...
// URL completa da API
const urlAPI = `https://vexapi.com.br/api/edits/wojakreaction?apikey=${apikey}&query=${encodeURIComponent(urlImagemOriginal)}`;

// Caminho para salvar a imagem processada
const destinoLocal = path.join(__dirname, 'wojakreaction.jpg');
...
(async () => {
    try {
        console.log('🔹 Baixando imagem com efeito Wojak Reaction da Vex API...');
 ...
 *   - Perfeito para criação de memes rápidos.
 *
 * 👨‍💻 CRIADO POR:
 *   Vex Tech Solutions
 *
