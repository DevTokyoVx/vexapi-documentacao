 ...
 *
 * 🧠 DESCRIÇÃO:
 *   Coleta as notícias e manchetes focadas em política e economia do portal Poder360.
 *
 * ⚙️ PARÂMETROS:
 ...
 * 📤 RESPOSTA:
 *   Tipo: JSON
 *   Retorna um array de objetos com títulos, imagens e links.
 *
 * 💡 EXEMPLO DE USO:
 */
...
const url = `https://vexapi.com.br/api/news/poder360?apikey=${apikey}&query=${query}`;
...
(async () => {
    try {
        console.log('🚀 Buscando notícias do Poder360...\n');

        const dados = await buscarVexAPI(url);

        if (dados?.resposta?.length) {
            console.log('==============================');
            console.log('📰 ÚLTIMAS NOTÍCIAS - PODER360');
            console.log('==============================\n');
 ...
 *   - Especializado em jornalismo político e econômico.
 *
 * 👨‍💻 CRIADO POR:
 *   Vex Tech Solutions
 *
