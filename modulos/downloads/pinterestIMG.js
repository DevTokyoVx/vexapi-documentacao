/**
 * ============================================
 * 📡 VEX API - DOWNLOADS / PINTEREST IMG
 * ============================================
 *
 * 🔗 ENDPOINT:
 ...
 * 📤 RESPOSTA:
 *   Tipo: JSON
 *   Retorna uma lista de objetos contendo o tipo e a URL de cada imagem encontrada.
 *
 * 💡 EXEMPLO DE USO:
 */
...
/**
 * 🚀 OBSERVAÇÕES:
 *   - Suporta pins com uma ou múltiplas imagens (carrossel).
 *   - As URLs de saída apontam diretamente para os servidores do Pinterest.
 *
 * 👨‍💻 CRIADO POR:
 *   Vex Tech Solutions
 *
