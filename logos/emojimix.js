 ...
 * 
 * EXEMPLO DE USO:
 *  - Primeiro emoji: 😃  (query=%F0%9F%98%83%EF%B8%8F)
 *  - Segundo emoji: 🔥  (emoji2=%F0%9F%94%A5)
...
const emoji1 = '😃'; // Primeiro emoji
const emoji2 = '🔥'; // Segundo emoji

// URL completa da API Emojimix
const urlAPI = `https://vexapi.com.br/api/logos/emojimix?apikey=${apikey}&query=${encodeURIComponent(emoji1)}&emoji2=${encodeURIComponent(emoji2)}`;
...
(async () => {
    try {
        console.log(`🔹 Gerando emojimix de "${emoji1}" + "${emoji2}"...`);
